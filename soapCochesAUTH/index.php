    ...
    <div class="inner">
        ...
        <div class="thumbnails">
            ...
            foreach ($marcas as $marca => $url) {
                ?>
                <div class="box" data-marca="<?= $marca ?>">
                    <a href="<?= $url ?>" class="image fit" title="ver video">
                        <img src="images/<?= strtolower($marca) ?>.png" alt="logo <?= $marca ?>"/>
                    </a>
                    <div class="inner">
                        <h3>
                            <a href="modelos.php?marca=<?= $marca ?>" class="modelos-link" data-marca="<?= $marca ?>"
                               data-poptrox="ajax,600x400">
                                Modelos <?= $marca ?>
                            </a>
                        </h3>
                        <a href="<?= $url ?>" class="button style2 fit" data-poptrox="youtube,800x400">
                            Ver video <?= $marca ?>
                        </a>
                    </div>
                </div>
...
<script>
    $(document).ready(function () {
        $('.modelos-link').click(function (event) {
